...
if ( ! function_exists( 'business_hub_powerby' ) ) :
    ...
    <div id="copyright">
        <p><?php echo esc_html( $theme_options['copyright'] ); ?>. <?php printf( esc_html__( 'Theme: %1$s by %2$s.', 'business-hub' ), 'Business Hub', '<a href="http://rigorousthemes.com/" rel="designer" target="_blank">Rigorous Themes</a>' ); ?></p>
    </div>
